...
class _AddExpensesScreen extends State<AddExpensesScreen> {
  ...
  Future<void> _saveExpense() async {
    ...
    final transaction = TransactionModel(
      ...
      // read(), not watch() — this is a one-time snapshot of whatever
      // currency is active RIGHT NOW, at the moment of saving. It gets
      // baked into this transaction permanently; changing the currency
      // setting later never touches this value again.
