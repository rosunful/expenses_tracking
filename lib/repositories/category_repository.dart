...
class CategoryRepository {
  ...
  Future<void> addCategory(String name, CategoryType type, {String? iconKey}) async {
  ...
  /// Lets an already-created custom category's icon be changed later,
  /// independent of renaming — the icon avatar itself is tappable in
  /// the UI for this.
  Future<void> updateCategoryIcon(String categoryId, String iconKey) async {
    await _categoriesRef.doc(categoryId).update({'iconKey': iconKey});
  }
