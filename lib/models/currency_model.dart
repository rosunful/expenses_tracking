...
/// whatever the app's CURRENT setting happens to be. Falls back to USD
/// if the code isn't recognized (shouldn't normally happen, but keeps
/// this safe against bad/missing data).
